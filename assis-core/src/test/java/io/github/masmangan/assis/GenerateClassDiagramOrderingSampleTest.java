...
class GenerateClassDiagramOrderingSampleTest {
	...
	void packageAndTypeOrderingIsDeterministic() throws Exception {
		...
		String puml = generatePumlFromSample("samples/ordering", tempDir, "ordering");

		// If you want to lock package order:
		assertAppearsInOrder(puml, "package \"samples.ordering.p1\"", "package \"samples.ordering.p2\"");

		// If you want to lock type order within p1:
		assertAppearsInOrder(puml, "class \"samples.ordering.p1.A\"", "class \"samples.ordering.p1.B\"");
	}
}